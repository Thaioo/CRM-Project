...
//    }
	...
	try {
	    ...
	    // Kiểm tra các giá trị ngày hợp lệ
	    ...
	    req.setAttribute("errorMessage", "Invalid date format. Please enter a valid date in yyyy-MM-dd format.");
...
private void getProjectListAndMovingToProjectJSp(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	List<ProjectEntity> l = projectService.getAllProject();
